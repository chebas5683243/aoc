...
function getSeeds(contents) {
    var firstLine = contents[0];
    var _a = firstLine.split(":"), _ = _a[0], seedsString = _a[1];
    var seeds = seedsString.trim().split(" ").map(function (str) { return Number(str); });
    return seeds;
}
...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var contents, seeds, locations;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, processLineByLine()];
                case 1:
                    contents = _a.sent();
                    seeds = getSeeds(contents);
                    locations = getLocations(seeds, contents.slice(3));
